...
export function Skills() {
  ...
  return (
    ...
    >
      ...
      {/* Purple glow spots */}
      <div className="absolute top-[30%] left-[20%] w-[300px] h-[300px] rounded-full bg-purple-500/5 blur-[100px] pointer-events-none" aria-hidden="true" />
      <div className="absolute bottom-[20%] right-[15%] w-[250px] h-[250px] rounded-full bg-fuchsia-500/5 blur-[80px] pointer-events-none" aria-hidden="true" />
